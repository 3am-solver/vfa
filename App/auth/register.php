<?php
    ...
    $validate = mysqli_query($con, "SELECT name FROM `farmer` WHERE mobile = '$farmer_mobileno' or email = '$farmer_email';");
    ...
    if($validate_Rows == 0){ 
        ...
        $response = array("status" => false, "data" => "Email or Mobile Number already Registered...");
            echo json_encode($response);
    }
?>